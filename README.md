...
We use GitHub Issues as the official bug tracker for the DevFlix. Here are some advices for our users that want to report an issue:

1. Make sure that you are using the latest version of the DevFlix.
